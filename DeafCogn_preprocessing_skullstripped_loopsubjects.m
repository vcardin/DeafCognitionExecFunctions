...
sksanat= ;%skull stripped anatomical scan
...
matlabbatch{1}.spm.spatial.normalise.estwrite.subj.vol = cellstr(sksanat);
matlabbatch{1}.spm.spatial.normalise.estwrite.subj.resample =cellstr(sksanat);
...
clear matlabbatch anat datafolder_anat biasanat sksanat
...
c=1;
        ...
        matlabbatch{c}.spm.spatial.coreg.estimate.source = cellstr(spm_file(funct,'prefix','meanr'));
        ...
        clear matlabbatch  datafolder* funct biasanat short* long* wrap_img c
